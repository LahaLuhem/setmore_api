...
class DefaultApi {
  ...
  Future<Response<BookingapiCustomerCreatePost200Response>> bookingapiCustomerCreatePost({
    ...
    try {
      const _type = FullType(CreateCustomerRequestDto);
      _bodyData = _serializers.serialize(createCustomerRequestDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BookingapiCustomerCreatePost200Response),
            ) as BookingapiCustomerCreatePost200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<BookingapiCustomerGet200Response>> bookingapiCustomerGet({
    ...
    final _queryParameters = <String, dynamic>{
      r'firstname': encodeQueryParameter(_serializers, firstname, const FullType(String)),
      if (phone != null)
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BookingapiCustomerGet200Response),
            ) as BookingapiCustomerGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookingapiServicesCategoriesGet200Response>>
  ...
  Future<Response<BookingapiStaffsGet200Response>> bookingapiStaffsGet({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BookingapiStaffsGet200Response),
            ) as BookingapiStaffsGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
